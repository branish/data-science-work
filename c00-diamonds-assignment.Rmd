...
- Looking at the entire dataset, there appears to be a negative relationship between cut quality and price, and a positive relationship between carat and price.
- However, if carat is held constant, then there is a positive relationship between cut quality and price.
- If price is held constant, then there is a negative relationship between cut and carat.
- If cut is held constant, there is still a positive relationship between carat and price.
